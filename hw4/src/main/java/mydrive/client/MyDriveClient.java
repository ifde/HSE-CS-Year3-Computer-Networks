...
public class MyDriveClient {
    ...
    public MyDriveClient(String host, int port, String localDir, String clientId, int maxConnections) {
        this.host = host;
        this.port = port;
    ...
    public static void main(String[] args) throws Exception {
        ...
        int maxConnections = Integer.parseInt(props.getProperty("max.connections", "1"));

        MyDriveClient client = new MyDriveClient(host, port, localDir, clientId, maxConnections);
        client.sync();
    }
